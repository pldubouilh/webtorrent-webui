...
function HandlerWebtorrent (_torrentFolder, _downloadFolder, _verb, _hybrid, _dhtPort, _torrentPort) {
  ...
  this.intervalToken = setInterval(this.checkInterval.bind(this), this.checkTimeInterval)
}
...
HandlerWebtorrent.prototype.checkInterval = function () {
  ...
  this.client.torrents.forEach(t => {
    ...
    this.state.torrentDetail[t.infoHash] = translate.wtToTransmissionTorrentDetail(t, this.state)
...
HandlerWebtorrent.prototype.destroy = function (cb) {
