...
HandlerWebtorrent.prototype.ping = function () {
  this.pingCount = 10
  if (!this.checkIntervalToken || this.checkIntervalToken._called) this.checkInterval()
}
...
HandlerWebtorrent.prototype.checkInterval = function () {
  ...
  this.checkIntervalToken = setTimeout(this.checkInterval.bind(this), this.checkTimeInterval)
...
HandlerWebtorrent.prototype.isAddedCb = function (t) {
  ...
  t.on('upload', this.ping.bind(this))
  t.on('download', this.ping.bind(this))
...
HandlerWebtorrent.prototype.resumeTorrent = function (infoHash) {
  ...
  this.ping()
  this.client.add(this.state.torrentFiles[infoHash], this.webtorrentOpts, this.isAdded)
}
